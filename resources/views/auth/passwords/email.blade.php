        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-menu-col">
                    <a class="dropdown-item @if(App::isLocale('en')) current @endif" href="/password/reset?lang=en"><span class="flag-icon flag-icon-us"></span> English</a>
                    <a class="dropdown-item @if(App::isLocale('zh')) current @endif" href="/password/reset?lang=zh"><span class="flag-icon flag-icon-cn"></span> 中文</a>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-7">
                    <form class="sign-box" method="POST" action="{{ route('password.email') }}">
                        ...
                        @endif
                        <header class="sign-title" style="padding:30px 0; font-size:22px">{{ __('auth.hi') }}<b>{{ __('auth.grower') }}</b>, {{ __('auth.enter_email_to_reset') }}</header>
                        ...
                        <button type="submit" class="btn btn-rounded">{{ __('auth.send_reset_link') }}</button>
                    </form>
                </div>
            </div>
        </div>
