		...
		data() {
			return {
				menu:[ 
					...
					{color:'brown' , icon:' fa fa-sitemap' , title: 'organization', route: 'organization', opened: false, advisor: false},
					{color:'brown' , icon:' fa fa-money' , title: 'transactions', route: 'transactions', opened: false, advisor: false},
					// {color:'brown', icon:' fa fa-newspaper-o', title: 'news', route: 'news', opened: false},
					{color:'brown', icon:' fa fa-cube', title: 'redemptions', route: 'redemptions', opened: false},
					{color:'brown', icon:' fa fa-cubes', title: 'redeem_item', route: 'items', opened: false},
					// {color:'brown', icon:' fa fa-file-pdf-o', title: 'materials', route: 'materials', opened: false, advisor: false},
					{color:'brown', icon:' fa fa-exchange ', title: 'sell_account', route: 'resell', opened: false, advisor: false},
