	...
	<div>
		...
		<div v-if="isCompanyRegistration">
			<div class="form-group mt-2">
			    <label>{{ 'auth.company_name' | trans }}  <span class="text-danger">*</span></label>
			    <input name='company_name' type="text" class="form-control" :placeholder="$options.filters.trans('auth.company_name')" v-model="company_name" required/>
			</div>
			<div class="row">
				<div class="col-sm">
					<div class="form-group">
					    <label>{{ 'auth.company_business_registration' | trans }}  <span class="text-danger">*</span></label>
					    <input name='company_business_registration' type="text" class="form-control" :placeholder="$options.filters.trans('auth.company_business_registration')" v-model="company_business_registration" required/>
					</div>
				</div>
				<div class="col-sm">
					<div class="form-group">
					    <label>{{ 'auth.company_incorporation_date' | trans }}  <span class="text-danger">*</span></label>
					    <input name='company_incorporation_date' type="date" class="form-control" :placeholder="$options.filters.trans('auth.company_incorporation_date')" v-model="company_incorporation_date" required/>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-sm">
					<div class="form-group">
					    <label>{{ 'auth.company_incorporation_place' | trans }}  <span class="text-danger">*</span></label>
					    <input name='company_incorporation_place' type="text" class="form-control" :placeholder="$options.filters.trans('auth.company_incorporation_place')" v-model="company_incorporation_place" required/>
					</div>
				</div>
				<div class="col-sm">
					<div class="form-group">
					    <label>{{ 'auth.company_regulatory_name' | trans }}</label>
					    <input name='company_regulatory_name' type="text" class="form-control" :placeholder="$options.filters.trans('auth.company_regulatory_name')" v-model="company_regulatory_name"/>
					</div>
				</div>
				<div class="col-sm">
					...
					<input type="hidden" name="company_type" v-model="company_business_entity.value">
				</div>
			</div>
			<div class="form-group">
                <label>{{ 'auth.company_address' | trans }}  <span class="text-danger">*</span></label>
			...
			<div class="table-responsive">
				<table class="table">
					<thead>
						...
						<th><a @click="personnels.push([])" class="btn btn-sm btn-primary">{{ 'auth.add_personnel' | trans }}</a></th>
					</thead>
					<tbody>
...
<script>
	import SelectorInput from '../base/SelectorInput.vue';
	export default {
