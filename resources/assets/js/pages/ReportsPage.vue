							...
							<table class="table">
								...
								<tbody>
									<tr v-for="report_date in commission_dates">
										...
										<td>
											<a class="btn btn-danger" target="_blank" :href="'/exports/transactions?user=' + user_id + '&type=pdf&start=' + report_date.start.format('YYYY-MM-DD') + '&end=' + report_date.end.format('YYYY-MM-DD')">
